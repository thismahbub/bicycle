    ...
    <body bgcolor="#ff6699">
        ...
        <table border="0" cellpadding="5" cellspacing="5" width="900" bgcolor="#FFFFFF" id="container">
            ...
            <td width="750"><div id="l">Profile Name: <%=login.getMemberName()%>&nbsp;&nbsp;Member Email: &nbsp;<%=login.getEmail()%>&nbsp;&nbsp;<a href="logoutProcess.jsp">logout</a></div>
                <form action="addProccessBicycleOption.jsp" method="post"><fieldset>
                        ...
                        <div id="c">
                            ...
                            <table width="100%" cellspacing="10">
                                <tr>
                                    ...
                                    <td width="2%" id="c">:</td>
                                    <td width="75%" id="l"><input name="bicycleOptionID" type="text" size="40"></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td id="c">:</td>
                                    <td id="l"><input type="textfield" name="RetailerId" size="40"></td>
                                </tr>
                                <tr>
                                    <td id="l">Name</td>
                                    <td id="l">:</td>
                                ...
                                <tr>
                                    ...
                                    <td id="l">:</td>
                                    <td id="l"><textarea name="Description" cols="38" rows="5"></textarea></td>
                                </tr>
                                <tr>
                                    <td id="l">Price</td>
                                    <td id="l">:</td>
