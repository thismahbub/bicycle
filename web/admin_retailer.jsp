    ...
    <body bgcolor="#ff6699">
        ...
        <table border="0" cellpadding="5" cellspacing="5" width="900" bgcolor="#FFFFFF" id="container">
            ...
            <td width="750"><div id="l">Profile Name: <%=login.getMemberName()%>&nbsp;&nbsp;Member Email: &nbsp;<%=login.getEmail()%>&nbsp;&nbsp;<a href="logoutProcess.jsp">logout</a></div>
                <form action="addprocess.jsp" method="post"><fieldset>
                        <legend><b>Retailer Form</b></legend><div id="c">
                            <table width="100%" cellspacing="10">
                                <tr>
                                    <td width="17%" id="l"><label>Retailer ID</label></td>
                                    <td width="2%" id="c">:</td>
                                    <td width="81%" id="l"><input name="Retailer_Id" type="text" size="40"></td>
                                </tr>
                                <tr>
                                    <td id="l">Name</td>
                                    <td id="c">:</td>
                                    <td id="l"><input type="textfield" name="Retailer_Name" size="40"></td>
                                </tr>


                                <tr><td id="l">Address</td>
                                    <td id="l">:</td>
                                    <td id="l"><input type="text" name="Address"  size="40"></td></tr>
                                <tr>
                                    <td id="l">E-Mail</td>
                                    <td id="l">:</td>
                                    <td id="l"><input type="text" name="Email" size="40"></td>
                                </tr>
                                <tr>
                                    <td id="l">Phone</td>
                                    <td id="l">:</td>
                                    <td id="l"> <input type="text" name="Phone" size="40"></td>
                                </tr>
                                <tr>
