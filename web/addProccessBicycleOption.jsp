...
<html>
    ...
    <body>
        <%
            ...
            BicycleOption bicycleOption = new BicycleOption();

            bicycleOption.setBicycleOptionID(Integer.parseInt(request.getParameter("bicycleOptionID")));
            bicycleOption.setRetailer(new Retailer(Integer.parseInt(request.getParameter("RetailerId"))));
            ...
            if(myEntityManager.persist(bicycleOption))
                {
