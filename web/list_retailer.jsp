    ...
    <body bgcolor="#ff6699">
        ...
        <table border="0" cellpadding="5" cellspacing="5" width="900" bgcolor="#FFFFFF" id="container">
            ...
            <td width="750" valign="top"><div id="r">Profile Name: <%=login.getMemberName()%>&nbsp;&nbsp;Member Email: &nbsp;<%=login.getEmail()%>&nbsp;<a href="logoutProcess.jsp">logout</a></div><div>
                    <div style="color:#090; font-weight:bold;font-size:16px;"><u>Retailer Information</u></div><hr>
                    ...
                    <table border="1" cellspacing="1" cellpadding="1" width="747">
                        <tr>
                            ...
                            <td><%= searchResult.get(i).getNameOfRetailer()%></td>
                            <td><%= searchResult.get(i).getPostalAddress()%></td>
                            <td><%= searchResult.get(i).getEmailAddress()%></td>
                            <td><%= searchResult.get(i).getPhoneNumber()%></td>
                            <td><a href="admin_retailer_Edit.jsp?retailerID=<%= searchResult.get(i).getRetailerID()%>">Edit</a></td>
                            <td><a href="deleteRetailerProccess.jsp?retailerID=<%= searchResult.get(i).getRetailerID()%>">Delete</a></td>
                        </tr>
                        <%
                                    }
                        %>
