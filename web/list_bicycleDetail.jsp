    ...
    <body bgcolor="#ff6699">
        ...
        <table border="0" cellpadding="5" cellspacing="5" width="900" bgcolor="#FFFFFF" id="container">
            ...
            <td width="750" valign="top"><div id="r">Profile Name: <%=login.getMemberName()%>&nbsp;&nbsp;Member Email: &nbsp;<%=login.getEmail()%>&nbsp;<a href="logoutProcess.jsp">logout</a></div><div>
                    <div style="color:#090; font-weight:bold;font-size:16px;"><u>Bicycle Detail Information</u></div><hr>
                    ...
                    %>
                            ...
                            <td> <%= searchResult.get(i).getBicycleDetailID()%></td>
                            <td> <%= searchResult.get(i).getMake()%></td>
                            <td> <%= searchResult.get(i).getType()%></td>
                            <td> <%= searchResult.get(i).getColour()%></td>
                            <td> <%= searchResult.get(i).getFrameSize()%></td>
                            <td> <%= searchResult.get(i).getNumberOfGears()%></td>
                            <td> <%= searchResult.get(i).getWheelSize()%></td>
                            <td> <%= searchResult.get(i).getBasicPrice()%></td>
                            <td width="150"><a href="admin_bicycleDetail_Edit.jsp?bicycleDetailId=<%= searchResult.get(i).getBicycleDetailID()%>">Edit</a></td>
                            <td width="150"><a href="deleteBicycleDetailProccess.jsp?bicycleDetailId=<%= searchResult.get(i).getBicycleDetailID()%>">Delete</a></td>
                        </tr>
                        <%
                                    }
                        %>
