...
<table border="0" cellpadding="5" cellspacing="5" width="900" bgcolor="#FFFFFF" id="container">
    ...
    <tr></tr>
		...
		<td width="750" valign="top"><div id="r">Profile Name: <%=login.getMemberName()%>&nbsp;&nbsp;Member Email: &nbsp;<%=login.getEmail()%>&nbsp;&nbsp;<input name="Logout" type="button" value="Logout" /></div><div>
                        <div style="color:#090; font:sans-serif; font-size:20px;" id="vl">Process Successful</div>
