    ...
    <body bgcolor="#ff6699">
        ...
        <table border="0" cellpadding="5" cellspacing="5" width="900" bgcolor="#FFFFFF" id="container">
            ...
            <td width="750" valign="top"><div id="r">Profile Name: <%=login.getMemberName()%>&nbsp;&nbsp;Member Email: &nbsp;<%=login.getEmail()%>&nbsp;<a href="logoutProcess.jsp">logout</a></div><div>
                    <div style="color:#090; font-weight:bold;font-size:16px;"><u>Bicycle Option Information</u></div><hr>
                    ...
                    <table border="1" cellspacing="1" cellpadding="1" width="747">
                        <tr>
                            ...
                            <td> <%= searchResult.get(i).getBicycleOptionID()%></td>
                            <td> <%= searchResult.get(i).getRetailer().getRetailerID()%></td>
                            <td> <%= searchResult.get(i).getNameOfOption()%></td>
                            <td> <%= searchResult.get(i).getDeacriptionOfOption()%></td>
                            <td> <%= searchResult.get(i).getPriceOfOption()%></td>
                            <td width="150"><a href="admin_bicycleOption_edit.jsp?bicycleOptionID=<%= searchResult.get(i).getBicycleOptionID()%>">Edit</a></td>
                            <td width="150"><a href="deleteOptionProccess.jsp?bicycleOptionID=<%= searchResult.get(i).getBicycleOptionID()%>">Delete</a></td>
                        </tr>
                        <%
                                    }
                        %>
