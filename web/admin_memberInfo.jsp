    ...
    <body bgcolor="#ff6699">
        ...
        <table border="0" cellpadding="5" cellspacing="5" width="900" bgcolor="#FFFFFF" id="container">
            ...
            <td width="750"><div id="l">Profile Name: <%=login.getMemberName()%>&nbsp;&nbsp;Member Email: &nbsp;<%=login.getEmail()%>&nbsp;&nbsp;<a href="logoutProcess.jsp">logout</a></div>
                <form action="addMemberInfo.jsp" method="post"><fieldset>
                        ...
                        <div id="c">
                            ...
                            <table width="100%" cellspacing="10">
                                <tr>
                                    ...
                                    <td width="2%" id="c">:</td>
                                    <td width="75%" id="l"><input name="username" type="text" size="40"></td>
                                </tr>
                                <tr>
                                    <td id="l">Password</td>
                                    <td id="c">:</td>
                                    <td id="l"><input name="password" type="password" size="40"></td>
                                </tr>
                                <tr>
                                    <td id="l">Member Name</td>
                                    <td id="l">:</td>
                                    <td id="l"><input type="text" name="name"  size="40"></td></tr>
                                <tr>
                                    <td id="l">E-Mail</td>
                                    <td id="l">:</td>
                                    <td id="l"><input type="text" name="email" size="40"></td></tr>
                                <tr>
                                <tr>
                                    <td id="l">Level</td>
                                    <td id="l">:</td>
                                    <td id="l"><input type="text" name="level" size="40"></td></tr>
                                <tr>
