    ...
    <body bgcolor="#ff6699">
        ...
        <table border="0" cellpadding="5" cellspacing="5" width="900" bgcolor="#FFFFFF" id="container">
            ...
            <td width="750"><div id="l">Profile Name: <%=login.getMemberName()%>&nbsp;&nbsp;Member Email: &nbsp;<%=login.getEmail()%>&nbsp;&nbsp;<a href="logoutProcess.jsp">logout</a></div>
                <form action="addMemberServeyProcess.jsp" method="post"><fieldset><legend><b>Search Here</b></legend><div id="c">


                            <table width="100%" cellspacing="10">
                                <tr>
                                    <td width="17%" id="l"><label>User Name</label></td>
                                    <td width="2%" id="c">:</td>
                                    <td width="81%" id="l"><input name="username" type="text" size="70" value="<%=login.getMemberName()%>"></td>
                                </tr>
                                <tr>
                                    <td width="17%" id="l"><label>Interest</label></td>
                                    <td width="2%" id="c">:</td>
                                    <td width="81%" id="l"><input name="interest" type="text" size="70"></td>
                                </tr>
                                <tr>
                                    <td id="l">Comment</td>
                                    <td id="c">:</td>
                                    <td id="l"><textarea name="comment" cols="50" rows="5"></textarea></td>
                                </tr>

                                <tr>
                                    <td colspan="4" id="c"><input type="Submit" name="Submit" value="Submit"></td></tr>
                            </table>
                        </div></fieldset></form>
